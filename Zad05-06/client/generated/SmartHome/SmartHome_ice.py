...
if 'CurrentIntensitySetting' not in _M_SmartHome.__dict__:
    _M_SmartHome.CurrentIntensitySetting = Ice.createTempClass()
    class CurrentIntensitySetting(_M_SmartHome.BaseSetting):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_SmartHome._t_CurrentIntensitySetting)

        __repr__ = __str__

    _M_SmartHome._t_CurrentIntensitySetting = IcePy.defineValue('::SmartHome::CurrentIntensitySetting', CurrentIntensitySetting, -1, (), False, False, _M_SmartHome._t_BaseSetting, (('intensity', (), IcePy._t_short, False, 0),))
    CurrentIntensitySetting._ice_type = _M_SmartHome._t_CurrentIntensitySetting

    _M_SmartHome.CurrentIntensitySetting = CurrentIntensitySetting
    del CurrentIntensitySetting
...
_M_SmartHome._t_IDoor = IcePy.defineValue('::SmartHome::IDoor', Ice.Value, -1, (), False, True, None, ())

if 'IDoorPrx' not in _M_SmartHome.__dict__:
    _M_SmartHome.IDoorPrx = Ice.createTempClass()
    class IDoorPrx(Ice.ObjectPrx):

        def close(self, context=None):
            return _M_SmartHome.IDoor._op_close.invoke(self, ((), context))

        def closeAsync(self, context=None):
            return _M_SmartHome.IDoor._op_close.invokeAsync(self, ((), context))

        def begin_close(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_SmartHome.IDoor._op_close.begin(self, ((), _response, _ex, _sent, context))

        def end_close(self, _r):
            return _M_SmartHome.IDoor._op_close.end(self, _r)

        def open(self, context=None):
            return _M_SmartHome.IDoor._op_open.invoke(self, ((), context))

        def openAsync(self, context=None):
            return _M_SmartHome.IDoor._op_open.invokeAsync(self, ((), context))

        def begin_open(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_SmartHome.IDoor._op_open.begin(self, ((), _response, _ex, _sent, context))

        def end_open(self, _r):
            return _M_SmartHome.IDoor._op_open.end(self, _r)

        @staticmethod
        def checkedCast(proxy, facetOrContext=None, context=None):
            return _M_SmartHome.IDoorPrx.ice_checkedCast(proxy, '::SmartHome::IDoor', facetOrContext, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return _M_SmartHome.IDoorPrx.ice_uncheckedCast(proxy, facet)

        @staticmethod
        def ice_staticId():
            return '::SmartHome::IDoor'
    _M_SmartHome._t_IDoorPrx = IcePy.defineProxy('::SmartHome::IDoor', IDoorPrx)

    _M_SmartHome.IDoorPrx = IDoorPrx
    del IDoorPrx

    _M_SmartHome.IDoor = Ice.createTempClass()
    class IDoor(Ice.Object):

        def ice_ids(self, current=None):
            return ('::Ice::Object', '::SmartHome::IDoor')
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_SmartHome._t_IDoorDisp)

        __repr__ = __str__

    _M_SmartHome._t_IDoorDisp = IcePy.defineClass('::SmartHome::IDoor', IDoor, (), None, ())
    IDoor._ice_type = _M_SmartHome._t_IDoorDisp

    IDoor._op_close = IcePy.Operation('close', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, None, (), (), (), ((), IcePy._t_string, False, 0), ())
    IDoor._op_open = IcePy.Operation('open', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, None, (), (), (), ((), IcePy._t_string, False, 0), ())

    _M_SmartHome.IDoor = IDoor
    del IDoor

if 'Door' not in _M_SmartHome.__dict__:
    _M_SmartHome.Door = Ice.createTempClass()
    class Door(Ice.Value):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_SmartHome._t_Door)

        __repr__ = __str__

    _M_SmartHome._t_Door = IcePy.defineValue('::SmartHome::Door', Door, -1, (), False, False, None, (
        ('name', (), IcePy._t_string, False, 0),
        ('isClosed', (), IcePy._t_bool, False, 0)
    ))
    Door._ice_type = _M_SmartHome._t_Door

    _M_SmartHome.Door = Door
    del Door
