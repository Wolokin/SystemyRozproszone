...
public interface CalcPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default float avg(int[] seq)
    {
        return avg(seq, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default float avg(int[] seq, java.util.Map<String, String> context)
    {
        return _iceI_avgAsync(seq, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Float> avgAsync(int[] seq)
    {
        return _iceI_avgAsync(seq, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Float> avgAsync(int[] seq, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Float> _iceI_avgAsync(int[] iceP_seq, java.util.Map<String, String> context, boolean sync)
    {
