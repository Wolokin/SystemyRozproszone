...
import SmartHome.IBulbulatorPrx;
import SmartHome.SmartDevicePrx;
...
public class IceClient 
{
	public static void main(String[] args) throws InterruptedException {
		...
		try {
			...
			ObjectPrx base1 = communicator.propertyToProxy("Bulbulator.Proxy");
...
//			ObjectPrx base1 = communicator.stringToProxy("calc/calc11:tcp -h 127.0.0.2 -p 10000 -z : udp -h 127.0.0.2 -p 10000 -z"); //opcja -z w³¹za **mo¿liwoœæ** kompresji
			...
			IBulbulatorPrx obj1 = IBulbulatorPrx.checkedCast(base1);
			...
			do	{
				try	{
					...
					if(line.equals("getData")) {
						System.out.println(Arrays.toString(obj1.getData()));
					}
...
//						float r = obj1.avg(new int[]{1, 2, 3});
//						System.out.println("RESULT = " + r);
//					}
