...
public class LightControllerI extends SmartDeviceI implements ILightController {
    ...
    public LightControllerI() {
        super(new LightController(new DeviceMetadata("Bulbulator", ThreadLocalRandom.current().nextInt(SERIAL_MAX)), new LightControllerData(LightMode.off, new LightMode[]{LightMode.off, LightMode.normal})));
